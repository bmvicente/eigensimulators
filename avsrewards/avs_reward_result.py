...
def reward_sum(reward_percentage, profit_percentage, selected_avs_tvl_total_staked_adjustment, selected_avs_revenue_adjustment, selected_avs_audits_adjustment, selected_avs_dual_staking_adjustment, selected_avs_type_adjustment):
        return reward_percentage + profit_percentage + selected_avs_tvl_total_staked_adjustment + selected_avs_revenue_adjustment + selected_avs_audits_adjustment + selected_avs_dual_staking_adjustment + selected_avs_type_adjustment
...
def staker_reward(reward_percentage, profit_percentage, staker_percentage):
        return selected_avs_revenue_adjustment * reward_percentage * profit_percentage * staker_percentage

staker_reward_result = staker_reward(reward_percentage, profit_percentage, staker_percentage)


def operator_reward(reward_percentage, profit_percentage, operator_percentage):
        return selected_avs_revenue_adjustment * reward_percentage * profit_percentage * operator_percentage

operator_reward_result = operator_reward(reward_percentage, profit_percentage, operator_percentage)

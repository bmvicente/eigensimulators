...
#########################################
    ...
    st.write(f"""
                ...
                ***Operator Reward*** is naturally being given greater weight than the ***Staker Reward*** due to their paramount role in validating modules crucial to the well-function of an AVS. We've assigned 60% of the distributable rewards to Operators and 40% to Stakers and Restakers.

...
def prediction_market_app():
    ...
    with st.expander("How this Simulator Works"):
        st.markdown("""
            ...
            Potential returns distribution was also taken into account for every involved party: Winning bettors, EigenDA, Rio Network (LRT issuer), Rollup service, tokensight, Operators, and Restakers.

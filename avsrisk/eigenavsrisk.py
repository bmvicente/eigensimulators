    ...
    with col1:
        ...
        tvl_total_restaked_calc = f"""
            <div style="text-align: center;">
                ...
                <span style="font-size: 24px; font-weight: bold;">&times;</span>
                <span style="font-size: 22px; font-weight: bold; background-color: lightorange; border-radius: 10px; padding: 5px; margin: 2px;">{tvl_total_restaked_impact}</span> 
...
#########################################
    ...
    st.markdown("""
                ...
                <div class="big-font">
                The <strong>AVS Risk Score</strong> is normalized to range from 0 to 100 (for easy reading), where 0 indicates the lowest level of risk and 100 represents the highest possible risk.
                </div>
                <br>

...
#########################################
    ...
    st.write("""
            ...
            The Risk Score is based on the risk level of each input parameter as well as their weighting, which is composed of each risk's **Likelihood** and **Impact** to the AVS. 

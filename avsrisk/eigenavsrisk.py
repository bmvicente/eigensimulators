...
#########################################
    ...
    st.write("""
            ...
            The Risk Score is calculated based on the sum of each input parameter risk level as well as their weighting, which is composed of each risk's **Likelihood** and **Impact** to the AVS. 

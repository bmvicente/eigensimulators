...
# StakeSure & Non-Mal Op

### With Naive case in mind...
# Re-listen to podcast
# Read paper
...
def main():
    ...
    st.subheader("**AVS <> Operator Potential Slashing Event Simulator:** *STAKESURE Approach* & *Non-Malicious Operator*")

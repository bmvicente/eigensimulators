...
#########################################
    ...
    <div style="
        ...
        <h2 style="color: black; margin:0; font-size: 1.4em;">Normalized Espresso Risk Score: <span style="font-size: 1.5em; color: {color};">{st.session_state.risk_score:.0f}</span></h2>
    </div>
    """, 
    unsafe_allow_html=True
    )

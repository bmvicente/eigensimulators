   ...
   # with st.expander("Logic"):
    ...
    final_result_html = f"""
                <div style="text-align: center;">
                    ...
                    <span style="font-size: 22px; font-weight: bold;">(</span>
                    <span style="font-size: 22px; font-weight: bold;">(</span>
                    <span style="font-size: 22px; font-weight: bold; padding: 5px; margin: 2px;">{int(result4_norm):,}</span>
                    <span style="font-size: 22px; font-weight: bold;"> x </span>
                    <span style="font-size: 22px; font-weight: bold; padding: 5px; margin: 2px;">{result5_norm}</span>
                    <span style="font-size: 22px; font-weight: bold;">)</span>
                    <span style="font-size: 22px; font-weight: bold;"> x </span>
                    <span style="font-size: 22px; font-weight: bold;">(</span>
                    <span style="font-size: 22px; font-weight: bold; padding: 5px; margin: 2px;">{int(result6_norm):,}</span>
                    <span style="font-size: 22px; font-weight: bold;"> x </span>
                    <span style="font-size: 22px; font-weight: bold; padding: 5px; margin: 2px;">{result7_norm}</span>
                    <span style="font-size: 22px; font-weight: bold;">)</span>
                    <span style="font-size: 22px; font-weight: bold;"> x </span>
                    <span style="font-size: 22px; font-weight: bold;">(</span>
                    <span style="font-size: 22px; font-weight: bold; padding: 5px; margin: 2px;">{int(result8_norm):,}</span>
                    <span style="font-size: 22px; font-weight: bold;"> x </span>

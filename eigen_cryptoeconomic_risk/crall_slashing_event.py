        ...
        with col18:
            st.markdown(
                ...
                <div style="
                    ...
                    text-align: center;
                    margin: 5px 0;">
                    <h2 style="color: black; margin:0; font-size: 1em;">Own Amount Staked on <i>AVS 1</i>: <span style="font-size: 1.1em;">{stake_avs_1:,.0f}</span></h2>
                </div>
                """, 
                unsafe_allow_html=True
            )
        ...
        with col19:
            st.markdown(
                ...
                <div style="
                    ...
                    text-align: center;
                    margin: 5px 0;">
                    <h2 style="color: black; margin:0; font-size: 1em;">Own Amount Staked on <i>AVS 2</i>: <span style="font-size: 1.1em;">{stake_avs_2:,.0f}</span></h2>
                </div>
                """, 
                unsafe_allow_html=True
            )
        ...
        with col20:
            st.markdown(
                ...
                <div style="
                    ...
                    text-align: center;
                    margin: 5px 0;">
                    <h2 style="color: black; margin:0; font-size: 1em;">Own Amount Staked on <i>AVS 3</i>: <span style="font-size: 1.1em;">{stake_avs_3:,.0f}</span></h2>
                </div>
                """, 
                unsafe_allow_html=True
            )
    ...
    with col1:
        ...
        st.markdown(
                ...
                <div style="
                    ...
                    <h2 style="color: black; margin: 0; font-size: 1.1em;">
                        <div style="display: block;">
                            <span style="font-weight: bold; font-size: 1em;">Ω<sub style="font-size: 1em;">AVS2</sub></span> &nbsp; | &nbsp; Potential Max Slash Exposure to a Set of Operators based on AVS Risk Profile: <span style="font-size: 1.1em;">${potential_total_slashing2:,.0f}</span>
                        </div>
                    </h2>
                </div>
                """, 
        ...
        st.markdown(
                ...
                <div style="
                    ...
                    <h2 style="color: black; margin: 0; font-size: 1.1em;">
                        <div style="display: block;">
                            <span style="font-weight: bold; font-size: 1em;">Ω<sub style="font-size: 1em;">AVS3</sub></span> &nbsp; | &nbsp; Potential Max Slash Exposure to a Set of Operators based on AVS Risk Profile: <span style="font-size: 1.1em;">${potential_total_slashing3:,.0f}</span>
                        </div>
                    </h2>
                </div>
                """, 

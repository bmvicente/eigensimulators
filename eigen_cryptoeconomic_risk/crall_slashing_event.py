    ...
    with col1:
        ...
        st.markdown(
            ...
            <div style="
                ...
                text-align: center;
                margin: 5px 0;">
                <h2 style="color: black; margin:0; font-size: 1em;">Potential Max Slash Exposure to a Set of Operators based on AVS Risk Profile: <span style="font-size: 1.1em;">{potential_total_slashing1:,.0f}</span></h2>
            </div>
            """, 
            unsafe_allow_html=True
            )
        ...
        st.markdown(
            ...
            <div style="
                ...
                text-align: center;
                margin: 5px 0;">
                <h2 style="color: black; margin:0; font-size: 1em;">Potential Max Slash Exposure to a Set of Operators based on AVS Risk Profile: <span style="font-size: 1.1em;">{potential_total_slashing3:,.0f}</span></h2>
            </div>
            """, 
            unsafe_allow_html=True
            )

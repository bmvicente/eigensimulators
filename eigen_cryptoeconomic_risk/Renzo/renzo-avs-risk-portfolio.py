...
def main():
    ...
    st.markdown("""
                ...
                <div class="big-font">
                The <strong>Sharpe Ratio</strong> calculation takes into account both AVS Risk and Yield statuses to compute Risk/Return performance of the AVS as a portfolio asset to Renzo.
                </div>
                """, unsafe_allow_html=True)

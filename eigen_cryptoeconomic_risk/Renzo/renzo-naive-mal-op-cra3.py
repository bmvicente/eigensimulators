...
###########################################################
    ...
    with st.expander("Logic"):
                st.markdown(f"""
                    ...
                    - If all the AVSs bought an appropriate amount of insurance, the system is cryptoeconomically secure. There's no need to revert to the Reserve or Buffer;
                    - The system is cryptoeconomically insecure a) if **Post-Slash STAKESURE Insurance Available > 0** and NOT all AVSs bought an appropriate amount of insurance, or if b) **STAKESURE Insurance Available < Σ(Insured Ψj)** and if NOT all AVSs bought an appropriate amount of Insurance;

...
def main():
    ...
    with st.expander("How this Simulator Works & Basic Assumptions"):
        st.markdown("""
                    ...
                    Whilst inbetween Naive and STAKESURE approaches there exist mechanisms around Reversion Periods for Reorg attacks to further levy CoC and reduce chances at extracting PfC, we took the Naive case and then went straight to STAKESURE. This unorthodox bridging is helpful since we take the scenario of lesser possible security and stress-test STAKESURE to try safeguard against that scenario.
                    """)

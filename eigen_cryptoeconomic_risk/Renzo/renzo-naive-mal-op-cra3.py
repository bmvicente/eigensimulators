    ...
    st.markdown(
        ...
        <div style="
            ...
            <h2 style="color: black; margin: 0; font-size: 1.4em;">
                <div style="display: block; margin-top: 5px;">
                    <span style="font-size: 1.2em;"><i>StakeSure</i></span> - Available Insurance Reserve <span style="font-size: 0.8em; font-weight: normal;">(Tt+1 / 2)</span>: <span style="font-size: 1.1em;">${stakesure_insurance_reserve:,.0f}</span>

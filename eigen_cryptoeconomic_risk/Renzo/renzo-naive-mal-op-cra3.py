...
###########################################################
    ...
    with st.expander("Logic"):
                st.markdown(f"""
                    ...
                    - The system is always cryptoeconomically insecure to some degree if NOT all AVSs bought an appropriate amount of Insurance. a) if **Post-Slash STAKESURE Insurance Available > 0** and , or if b) **Post-Slash STAKESURE Insurance Available < 0** and if NOT all AVSs bought an appropriate amount of Insurance;
                    - If it so happens that **Post-Slash STAKESURE Insurance Available < 0** and if NOT all AVSs bought an appropriate amount of Insurance;

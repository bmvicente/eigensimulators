...
###########################################################
    ...
    st.markdown(
            ...
            <div style="
                ...
                <h2 style="color: black; margin: 0; font-size: 1.4em;">
                    <div style="display: block; margin-top: 5px;">
                    <span style="font-size: 0.9em;">Cryptoeconomic <i>Buffer</i> Insurance Available for Poorly Insured or Uninsured Users (t+1) = $<span style="font-size: 1.1em;">{buffer_reserve_amount:,.0f}</span>
                    </div>
                </h2>
            </div>
            """, 

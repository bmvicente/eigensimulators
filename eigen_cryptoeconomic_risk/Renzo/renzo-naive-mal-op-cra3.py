...
###########################################################
    ...
    with st.expander("Logic"):
                st.markdown(f"""
                    ...
                    - The system is cryptoeconomically insecure a) if **Post-Slash STAKESURE Insurance Available > 0** and NOT all AVSs bought an appropriate amount of insurance, or if b) **Post-Slash STAKESURE Insurance Available < 0)** and if NOT all AVSs bought an appropriate amount of Insurance;

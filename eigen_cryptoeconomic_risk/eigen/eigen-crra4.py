    ...
    with col96:
        fractiona_html = """
            <div style="text-align: center;">
                ...
                <div style="display: inline-block; vertical-align: middle; font-size: 22px; font-weight: bold; text-align: center;">
                    <span>AVS Sharpe Ratio <span style="font-size: 28px;">-</span> Compounded Loss(Ψj)/Actual Slash(δj) Ratio Factor <span style="font-size: 28px;">-</span> AVS Insurance Status Factor</span>
                </div>
            </div> """

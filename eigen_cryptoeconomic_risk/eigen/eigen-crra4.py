...
###########################################################
    ...
    with col80:
        ...
        with col86:
            ...
            avs1_st_dev_html = f"""&bull; AVS1 Standard Deviation: ${avs1_revenue:,.0f} * {avs1_st_dev:.0f}% = <b>${avs1_st_dev_abs:,.0f}</b>"""
            
            st.markdown(avs1_st_dev_html, unsafe_allow_html=True)

        ...
        with col70:
            ...
            st.markdown(
                ...
                <div style="
                    ...
                    margin: 10px 0;
                    background-color: white;">
                    <h2 style="color: black; margin:0; font-size: 1em;">$AVS3 Staker / xETH Restaker Reward: <span style="font-size: 1.2em;">m</span></h2>
                </div>
                """, 
                unsafe_allow_html=True
            )
        ...
        with col71:
            ...
            st.markdown(
                ...
                <div style="
                    ...
                    margin: 10px 0;
                    background-color: white;">
                    <h2 style="color: black; margin:0; font-size: 1em;">AVS3 Operator Reward: <span style="font-size: 1.2em;">m</span></h2>
                </div>
                """, 
                unsafe_allow_html=True
            )

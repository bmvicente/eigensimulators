...
def main():
    ...
    st.write(f"""
            An Operator may be voluntarily or involuntarily undercollateralized. They may have position themselves that way to extract Profit from tasks they're validating or other ecosystem dependencies may have put them in that position and their collateralization status is non-malicious.

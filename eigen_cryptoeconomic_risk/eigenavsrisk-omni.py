...
def main():
    ...
    with col1:
        ...
        risk_score = omni_risk(security_audits, business_model, relayer_da_solution, relayer_merkle, evm_client_div, evm_equivalence, sybil_mec, encrypted_mempool_mec, st.session_state.code_complexity,
